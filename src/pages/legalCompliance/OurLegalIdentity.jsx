...
// // --- SVG Mapping (More unique components)---
// const svgMap = {
...
//   "default": (props) => <SVG_11_RegistrationDoc title="Cert." {...props} />,
// };
...
//   useEffect(() => {
//     if (!isInitialLoad.current && pages[activePageIndex]) {
//         const firstSectionId = pages[activePageIndex].sections[0].id;
//         navigate(`#${firstSectionId}`, { replace: true });
//     }
//   }, [activePageIndex, pages, navigate]);
