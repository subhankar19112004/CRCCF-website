...
const History = () => {
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-orange-100 p-6">
      <motion.div
      ...
      >
        <h1 className="text-3xl font-bold text-orange-900 mb-4">Our Story / History</h1>
        <p className="text-gray-700 text-lg leading-relaxed mb-6">
          Established in 2025, CRCCF was formed with a mission to safeguard digital India against cybercrimes.
        </p>
