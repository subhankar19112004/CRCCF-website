...
// Data import (using the path you provided)
import { softwareAndITServicesData } from '../../../data/OurServices/software_it_services/softwareAndITServices';


// -------------------------------------------------------------------
// 1. DYNAMIC TILT CARD COMPONENT (Blueprint Locked Design)
// -------------------------------------------------------------------
...
const DynamicTiltCard = ({ service, index }) => {
    ...
    const handleMouseMove = (e) => {
        ...
        // Map the coordinates to the tilt values
        const tiltRange = 20; 
        const tiltX = (y / rect.height) * tiltRange; 
        const tiltY = (x / rect.width) * tiltRange;

        // Animate the values using Framer Motion's springs
...
const SoftwareAndITServices = () => {
    return (
        <section className="w-full mx-auto px-2 sm:px-4 md:px-6 py-10 sm:py-12 md:py-16">
            ...
            {/* 2 cols on small, 3 on medium, 4 on large (adjusted for the 6 items, 3 is better than 4 or 2) */}
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-5">
                {softwareAndITServicesData.map((service, i) => (
...
export default SoftwareAndITServices;