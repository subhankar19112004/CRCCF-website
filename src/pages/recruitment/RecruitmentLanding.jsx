    ...
    <section className="bg-gray-50 pt-24 sm:pt-8 py-16 sm:py-20">
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 sm:mb-20">
          ...
          >
            Explore job opportunities, policies, and processes at CRCCF.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-y-10 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 lg:gap-x-8 lg:gap-y-6">
          {recruitmentData.map((item, index) => (
            ...
            >
              ...
              {/* Card Content */}
              <motion.div
                className="relative bg-white hover:border-gray-900 rounded-lg p-6 h-full flex flex-col z-10 border border-gray-900 group-hover:border-transparent transition-colors duration-300"
                variants={{ hover: { y: -8, transition: { type: 'spring', stiffness: 300 } } }}
              >
                <div
                ...
                >
                  ...
                  <motion.svg
                    ...
                    variants={{ hover: { x: 4, transition: { type: 'spring', stiffness: 400, damping: 15 } } }}
                  >
