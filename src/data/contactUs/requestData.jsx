// src/data/contactUs/requestData.jsx

export const requestFormSchema = [
  // --- SECTION 1: PERSONAL IDENTITY ---
  {
    sectionTitle: "Requester Identity",
    fields: [
      { 
        id: "fullName", 
        label: "Full Name", 
      ...
      { 
        ...
        required: false, 
        gridSpan: 2 // Full width for balance
      },
    ]
  },
  ...
  // --- SECTION 3: REQUEST DETAILS ---
  {
    ...
    fields: [
      { 
        id: "message", 
        label: "Formal Request Message", 
        type: "textarea", 
        placeholder: "Please describe your request, requirements, or case details here...", 
        required: true, 
        gridSpan: 2 
      }
    ]
