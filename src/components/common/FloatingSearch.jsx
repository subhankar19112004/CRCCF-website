...
// 🔥 NEW imports
import { softwareAndITServicesData } from "../../data/OurServices/software_it_services/softwareAndITServices.jsx";
import { websiteServicesData } from "../../data/OurServices/software_it_services/websiteServicesData.jsx";
import { mobileAppDevelopmentData } from "../../data/OurServices/software_it_services/mobileAppDevelopmentData.jsx";
import { dextopAndLaptopApplicationData } from "../../data/OurServices/software_it_services/dextopAndLaptopApplicationData.jsx";
...
const FloatingSearch = () => {
  ...
  const chipStyle = (src) => {
    ...
    const map = {
      ...
      // 🔥 NEW chips
      "software-it-services": "bg-slate-50 text-slate-700 ring-1 ring-slate-300",
      "website-services": "bg-sky-50 text-sky-700 ring-1 ring-sky-200",
      "mobile-app-development": "bg-lime-50 text-lime-700 ring-1 ring-lime-200",
      "desktop-laptop-development": "bg-purple-50 text-purple-700 ring-1 ring-purple-200",
  ...
  const allData = useMemo(() => {
    const mapSection = (arr, source) =>
      (arr || []).map((it, idx) => {
        ...
        const featuresText =
          Array.isArray(it.features) && it.features.length
            ? ` • ${it.features.join(" • ")}`
            : "";
        return {
          ...it,
          // 🔥 heading also supported (for your new data files)
          title: it.title || it.heading || it.name || it.label || "Untitled",
    ...
    return [
      ...
      // 🔥 NEW sections under software & IT
      ...mapSection(softwareAndITServicesData, "software-it-services"),
      ...mapSection(websiteServicesData, "website-services"),
      ...mapSection(mobileAppDevelopmentData, "mobile-app-development"),
      ...mapSection(dextopAndLaptopApplicationData, "desktop-laptop-development"),
  ...
  const baseMap = {
    ...
    // (no baseMap needed for new ones because they use full absolute paths)
    team: "/our-team/",
                ...
                {!query ? (
                  <div className="text-center text-gray-500 py-10 sm:py-12">
                    ...
                    <p className="mt-1 sm:mt-2 text-xs sm:text-sm">
                      Try “victim support”, “privacy policy”, “Instagram”,
                      “forensics”, “mentorship”…
                    </p>
                  </div>
                ) : results.length === 0 ? (
                  <div className="text-center text-gray-500 py-10 sm:py-12">
